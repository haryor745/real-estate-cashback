  ...
  return (
    ...
    >
      <div className="pdBigText">
        <h1>Property Saving Scheme</h1>
        <p>
          Capture and build your real estate investment/portfolio with{" "}
          <span>Propery Savings Scheme.</span>
        </p>
        <form>
          {/* <input
            type="email"
      ...
      <div className="pdGrid">
        <div className="pdText">
          <div className="pd-bio">
            ...
            <p>
              PSS is specially designed for low and medium- income earners who
          ...
          <div className="pd-part">
            ...
            <div className="lText">
              <h4>Invest</h4>
              <p>
                PSS allows you to invest a minimum of N20, 000 within the space
          ...
          <div className="pd-part">
            ...
            <div className="lText">
              ...
              <p>
                ...
                trading period. The profit is pegged at 15% for 12months
                duration.
              </p>
            </div>
          </div>
        ...
        <div className="pdText pdText2">
          ...
          <div className="pd-part">
            ...
            <div className="lText">
              ...
              <p>
                The following are the documents required when applying for PSS:
