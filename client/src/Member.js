      ...
      <div className="member-grid">
        <div className="side1">
          <div className="selector">
            ...
            <button
              className={`activate pdss ${active === "target" && "set"}`}
              onClick={() => {
                setActive("target");
              }}
            >
          ...
          <div className="padded">
            <h2>Become a Real Estate Cash Back Cooperative</h2>
            <ul>
              <li>
                <span>
                  <BsCheckLg />
        ...
        {active === "estate" && <EstateForm />}
        {active === "pdss" && <PdssForm />}
        {active === "target" && <TargetForm />}
      </div>
    </div>
  );
}
        ...
        >
          <SwiperSlide className="part1">
            <div className="form-text">
              ...
              <p>
                This information would be used to process your Real Estate Cash
                Back Transactions.
              </p>
            </div>
          ...
          <SwiperSlide className="part2">
            <div className="form-text">
              <h2>Real Estate Cash Back</h2>
              <p>
                This information allows us to personalize your real estate
                cashback experience and to provide relevant tips and content.
              </p>
            </div>
            ...
            <div className="radio-cont">
              ...
              <label htmlFor="upfront">
                ...
                />
                Upfront- 50% payable ( 24% for 12 months)
              </label>
            ...
            <div className="accept">
              <Link to="/faqs">Please read our Faqs here</Link>
            </div>
          ...
          <SwiperSlide className="part3">
            ...
            <div className="account-info">
              ...
              <p>
                Guarantee Trust Bank (GTB) <br /> Real Estate Cash Back <br />{" "}
                0696547068
              </p>
            </div>
            <div className="btn-cont">
        ...
        >
          ...
          <SwiperSlide className="part3">
            ...
            <div className="account-info">
              <h6>Account Details</h6>
              <p>
                Guarantee Trust Bank (GTB) <br /> Real Estate Cashback <br />{" "}
                0696547068
              </p>
            </div>
            <div className="btn-cont">
    ...
    <div className="side2">
      <form className="member-form" onSubmit={pdssSubmit}>
        ...
        >
          <SwiperSlide className="part1">
            <div className="form-text">
              <h2>Property Saving Scheme</h2>
              <p>
                This information is only used to improve your real estate
                cashback Experience, we won't share or communicate your data to
                any third party.
              </p>
            </div>
